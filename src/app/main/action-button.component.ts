...
@Component({
  ...
  template: `
    <div class="action-buttons">
      <button mat-icon-button (click)="onStartClick()" >
        <mat-icon>play_arrow</mat-icon>
      </button>
      <button mat-icon-button (click)="onStopClick()" >
        <mat-icon>pause</mat-icon>
      </button>
      <button mat-icon-button (click)="onStartUplink()" >
        <mat-icon style="transform: rotate(180deg);">get_app</mat-icon>
      </button>
      <button mat-icon-button (click)="onStopUplink()" >
